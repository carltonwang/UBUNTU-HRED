...
dump_raw_data(train_raw, train_set_path, word_index[bos_word], word_index[eos_word])

validate_raw = load_data(validate_raw_path)
dump_raw_data(validate_raw, validate_set_path, word_index[bos_word], word_index[eos_word])

test_raw = load_data(test_raw_path)
dump_raw_data(test_raw, test_set_path, word_index[bos_word], word_index[eos_word])